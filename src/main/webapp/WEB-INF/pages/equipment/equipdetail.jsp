                ...
                <form id="formSearch" class="form-horizontal">
                    <div class="form-group" style="margin:15px 0;">
                        ...
                        <div class="row custom">
                            <div class="col-md-3 col-sm-6 col-xs-6" style="padding: 0;" v-for="item in custom">
                                <label class="control-label col-md-4 col-sm-4 col-xs-4" :title="item.key">{{item.key + "："}}</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="height: 385px;overflow-y: auto;">
                    <form id="formSubmit" class="form-horizontal">
                        ...
                        <div class="form-group row" v-for="item in custom">
                            <label class="control-label item-left col-sm-4 col-xs-4 con">{{item.key + "："}}</label>
                            <div class="col-sm-7 col-xs-7">
